...
export const ROUTES: RouteMap = {
  ...
  '/goal/start0': { title: 'Referenz · Startseite' },
  '/goal/navbar1': { title: 'Referenz · Navigation 1' },
  '/goal/navbar2': { title: 'Referenz · Navigation 2' },
  '/goal/navbar3': { title: 'Referenz · Navigation 3' },
  '/goal/navbar4a': { title: 'Referenz · Navigation 4a' },
  '/goal/navbar4b': { title: 'Referenz · Navigation 4b' },
  '/goal/navbar5': { title: 'Referenz · Navigation 5' },
  '/goal/placeholder_page': { title: 'Referenz · Platzhalter' },
  '/goal/sidebar': { title: 'Referenz · Sidebar' }
};
